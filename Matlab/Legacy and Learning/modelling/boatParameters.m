...
% Inertia Matrix Paramters
Ixx    = 525.39;          % Roll inertia [kg.m^2]
Iyy    = 525.39;          % Pitch inertia [kg.m^2]
param.Izz    = 525.39;     % Yaw inertia [kg.m^2]

param.ICb = diag([Ixx,Iyy,param.Izz]);
% param.ICb = [Ixx,-Ixy,-Ixz;-Ixy,Iyy,-Iyz;-Ixz,-Iyz,param.Izz];
